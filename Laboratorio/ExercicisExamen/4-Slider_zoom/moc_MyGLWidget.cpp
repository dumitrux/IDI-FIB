...
QT_MOC_LITERAL(1, 11, 9), // "zoomMouse"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1), // "n"
QT_MOC_LITERAL(4, 24, 10) // "sliderZoom"

    },
    "MyGLWidget\0zoomMouse\0\0n\0sliderZoom"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->zoomMouse((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sliderZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::zoomMouse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::zoomMouse(int _t1)
{
