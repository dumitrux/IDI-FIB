...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        verticalSlider->setSizeIncrement(QSize(0, 0));
        ...
        QObject::connect(widget, SIGNAL(zoomMouse(int)), verticalSlider, SLOT(setValue(int)));
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(sliderZoom(int)));
