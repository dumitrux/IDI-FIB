...
void MyGLWidget::paintGL () 
{
  ...
  // Activem el VAO per a pintar el Cow
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(TG, glm::vec3(1, -0.125, 0));
  TG = glm::rotate(TG, girY, glm::vec3(0, 1, 0));
...
void MyGLWidget::modelTransformCow ()
{
  ...
  TG = glm::rotate(TG, -float(M_PI/2.0), glm::vec3(0, 0, 1));
  TG = glm::rotate(TG, girY, glm::vec3(0, 0, 1));
