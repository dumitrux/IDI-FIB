...
QT_MOC_LITERAL(1, 12, 14), // "colorLCDNumber"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 1), // "n"
QT_MOC_LITERAL(4, 30, 9) // "posarZero"

    },
    "MyLCDNumber\0colorLCDNumber\0\0n\0posarZero"
};
...
void MyLCDNumber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colorLCDNumber((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->posarZero(); break;
        default: ;
        }
    }
}
