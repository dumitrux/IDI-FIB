...
QT_MOC_LITERAL(1, 14, 13), // "assignarColor"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 1), // "n"
QT_MOC_LITERAL(4, 31, 11), // "colorRandom"
QT_MOC_LITERAL(5, 43, 5) // "color"

    },
    "MyQPushButton\0assignarColor\0\0n\0"
    "colorRandom\0color"
};
...
void MyQPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->assignarColor((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->colorRandom((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->color((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyQPushButton::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyQPushButton::assignarColor)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyQPushButton::assignarColor(int _t1)
{
